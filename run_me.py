...
if __name__ == "__main__":
    ...
    wordle_words = {word for word in english_words_lower_alpha_set if len(word) == GUESS_LENGTH}
    ...
    while True:
        ...
        guess_result = np.zeros(GUESS_LENGTH, dtype = object)
        ...
        if check_target_match(guess_result):    
            print(f"Woohoo! the final word was {guess_word.upper()}")
            break
        else:
